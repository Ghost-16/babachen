...
public class Config : MonoBehaviour
{
    ...
    // Physics parameters
    public static float G = 2.0f;  // Acceleration of gravity
    public static float SPACING = 1.2f;  // Spacing between particles, used to calculate pressure
    public static float K = SPACING / 10.0f;  // Pressure factor
    public static float K_NEAR = K * 10f;  // Near pressure factor, pressure when particles are close to each other
    public static float P_MASS = 0.0004f;
    ...
    public static float MAX_VEL = 10f;  // Maximum velocity of particles, used to avoid instability
